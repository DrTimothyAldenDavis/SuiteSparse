...
CHOLMOD Copyright\copyright 2005-2022 by Timothy A. Davis.  Portions are also
...
%-------------------------------------------------------------------------------
\newpage \section{Using CHOLMOD with OpenMP acceleration}
%-------------------------------------------------------------------------------
...
\verb'Common->chunk', and $m$ = \verb'Common->nthreads_max', then a parall
