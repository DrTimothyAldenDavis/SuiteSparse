...
You must first obtain and install METIS (if desired), LAPACK, and the BLAS.
METIS is optional.
...
you have CUDA installed, and whether or not you have METIS 4.0
placed in the SuiteSparse/ folder.  You still may need to edit it to refine the
...
{\tt make install}.  To remove it, do {\tt make uninstall}.
