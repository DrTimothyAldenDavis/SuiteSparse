//------------------------------------------------------------------------------
// CHOLMOD/Demo/cholmod_di_demo:  demo program for CHOLMOD
//------------------------------------------------------------------------------
...
int main (int argc, char **argv)
{
    ...
    if (prefer_zomplex && A->xtype == CHOLMOD_COMPLEX)
    {
        ...
        cholmod_sparse_xtype (CHOLMOD_ZOMPLEX + A->dtype, A, cm) ;
    }
...
#ifndef NMATRIXOPS
            double xnorm1 = cholmod_norm_dense (X, 1, cm) + ((n==0)?1:0) ;
