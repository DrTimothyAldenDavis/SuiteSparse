...
% Note that A=L*L' (LCHOL) and A=L*D*L' (LDLCHOL) factorizations are
% faster than R'*R (CHOL2 and CHOL) and use less memory.  The LL' and
% LDL' factorization methods use tril(A).  This method uses triu(A), just
% like the built-in CHOL.
%
%   Example:
