...
% depending on the matrix bisected.  s(i)=0 if node i is in the left
% subgraph, s(i)=1 if it is in the right subgraph, and s(i)=2 if node i
% is in the node separator.
%
