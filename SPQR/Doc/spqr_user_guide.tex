...
{\tt -DNPARTITION}, or if you delete or move the \verb'SuiteSparse_metis'
...
% FIXME: update this list of paths:
{\footnotesize
\begin{verbatim}
    ...
    addpath  /home/davis/SuiteSparse/CXSparse/MATLAB/ssget
...
Two compile-time options can be used to modify how SuiteSparseQR is compiled.
