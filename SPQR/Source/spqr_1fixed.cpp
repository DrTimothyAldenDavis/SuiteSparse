...
template int spqr_1fixed <Complex, SuiteSparse_long>
(
    double tol, SuiteSparse_long bncols, cholmod_sparse *A,
    SuiteSparse_long **p_R1p, SuiteSparse_long **p_P1inv,
    cholmod_sparse **p_Y, SuiteSparse_long *p_n1cols,
    SuiteSparse_long *p_n1rows, cholmod_common *cc
) ;

template int spqr_1fixed <double, SuiteSparse_long>
(
    double tol, SuiteSparse_long bncols, cholmod_sparse *A,
    SuiteSparse_long **p_R1p, SuiteSparse_long **p_P1inv,
    cholmod_sparse **p_Y, SuiteSparse_long *p_n1cols,
