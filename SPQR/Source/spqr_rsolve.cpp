...
(
    SuiteSparseQR_factorization <double, int32_t> *QR, int use_Q1fill,
    int32_t nrhs, int32_t ldb, double *B, double *X, double **Rcolp,
    int32_t *Rlive, double *W, cholmod_common *cc
) ;

template void spqr_rsolve <Complex, int32_t>
(
    SuiteSparseQR_factorization <Complex, int32_t> *QR, int use_Q1fill,
    int32_t nrhs, int32_t ldb, Complex *B, Complex *X, Complex **Rcolp,
    int32_t *Rlive, Complex *W, cholmod_common *cc
) ;

#if SuiteSparse_long_max != INT32_MAX

template void spqr_rsolve <double, SuiteSparse_long>
(
    SuiteSparseQR_factorization <double, SuiteSparse_long> *QR,
    int use_Q1fill, SuiteSparse_long nrhs, SuiteSparse_long ldb, double *B,
    double *X, double **Rcolp, SuiteSparse_long *Rlive, double *W,
    cholmod_common *cc
) ;

template void spqr_rsolve <Complex, SuiteSparse_long>
(
    SuiteSparseQR_factorization <Complex, SuiteSparse_long> *QR,
    int use_Q1fill, SuiteSparse_long nrhs, SuiteSparse_long ldb, Complex *B,
    Complex *X, Complex **Rcolp, SuiteSparse_long *Rlive, Complex *W,
    cholmod_common *cc
) ;
