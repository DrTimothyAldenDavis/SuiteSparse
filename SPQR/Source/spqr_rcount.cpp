...
(
    ...
    int32_t n1rows, int32_t econ, int32_t n2, int getT, int32_t *Ra, 
    int32_t *Rb, int32_t *H2p, int32_t *p_nh
) ;
...
template void spqr_rcount <double, SuiteSparse_long>
(
    ...
    int getT, SuiteSparse_long *Ra, SuiteSparse_long *Rb,
    SuiteSparse_long *H2p, SuiteSparse_long *p_nh
) ;

template void spqr_rcount <Complex, SuiteSparse_long>
(
    spqr_symbolic <SuiteSparse_long> *QRsym,
