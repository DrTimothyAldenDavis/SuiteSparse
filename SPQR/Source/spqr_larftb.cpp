...
template void spqr_larftb <double, SuiteSparse_long>
(
    int method, SuiteSparse_long m, SuiteSparse_long n, SuiteSparse_long k,
    SuiteSparse_long ldc, SuiteSparse_long ldv, double *V, double *Tau,
    double *C, double *W, cholmod_common *cc
) ;

template void spqr_larftb <Complex, SuiteSparse_long>
(
    int method, SuiteSparse_long m, SuiteSparse_long n, SuiteSparse_long k,
    SuiteSparse_long ldc, SuiteSparse_long ldv, Complex *V, Complex *Tau,
    Complex *C, Complex *W, cholmod_common *cc
) ;
