...
template int spqr_1colamd <double, SuiteSparse_long>
(
    int ordering, double tol, SuiteSparse_long bncols, cholmod_sparse *A,
    SuiteSparse_long **p_Q1fill, SuiteSparse_long **p_R1p,
    SuiteSparse_long **p_P1inv, cholmod_sparse **p_Y,
    SuiteSparse_long *p_n1cols, SuiteSparse_long *p_n1rows,
    cholmod_common *cc
) ;

template int spqr_1colamd <Complex, SuiteSparse_long>
(
    int ordering, double tol, SuiteSparse_long bncols, cholmod_sparse *A,
    SuiteSparse_long **p_Q1fill, SuiteSparse_long **p_R1p,
    SuiteSparse_long **p_P1inv, cholmod_sparse **p_Y,
