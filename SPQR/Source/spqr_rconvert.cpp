...
template void spqr_rconvert <double, SuiteSparse_long>
(
    spqr_symbolic <SuiteSparse_long> *QRsym,
    spqr_numeric <double, SuiteSparse_long> *QRnum,
    SuiteSparse_long n1rows, SuiteSparse_long econ, SuiteSparse_long n2,
    int getT, SuiteSparse_long *Rap, SuiteSparse_long *Rai, double *Rax,
    SuiteSparse_long *Rbp, SuiteSparse_long *Rbi, double *Rbx,
    SuiteSparse_long *H2p, SuiteSparse_long *H2i, double *H2x, double *H2Tau
) ;

template void spqr_rconvert <Complex, SuiteSparse_long>
(
    spqr_symbolic <SuiteSparse_long> *QRsym,
    spqr_numeric <Complex, SuiteSparse_long> *QRnum,
    SuiteSparse_long n1rows, SuiteSparse_long econ, SuiteSparse_long n2,
    int getT, SuiteSparse_long *Rap, SuiteSparse_long *Rai, Complex *Rax,
    SuiteSparse_long *Rbp, SuiteSparse_long *Rbi, Complex *Rbx,
    SuiteSparse_long *H2p, SuiteSparse_long *H2i, Complex *H2x,Complex *H2Tau
) ;
