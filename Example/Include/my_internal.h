...
#if !defined (SUITESPARSE__VERSION) || SUITESPARSE__VERSION < SUITESPARSE__VERCODE(7,13,1)
#error "This library requires SuiteSparse_config 7.13.1 or later"
#endif
...
#error "This library requires CXSparse 4.4.2 or later"
    ...
    #include "GraphBLAS.h"
        ...
        GxB_IMPLEMENTATION < GxB_VERSION (10,5,0)
    #error "This library requires SuiteSparse:GraphBLAS 10.5.0 or later"
    #endif
#endif
