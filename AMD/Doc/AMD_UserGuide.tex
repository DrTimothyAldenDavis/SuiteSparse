...
\verb'int32_t' integer arguments.  If you compile AMD in the standard
ILP32 mode (32-bit \verb'int32_t''s, \verb'int64_t''s, and pointers) then the versions
...
\verb'int32_t' remains 32-bits, but the size of a \verb'int64_t' and a pointer both get
promoted to 64-bits.
...
(\verb'int64_t' version: {\tt amd\_l\_valid})
    ...
    int32_t result = amd_valid (n, n, Ap, Ai) ;
    \end{verbatim}
    }
