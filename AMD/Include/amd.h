 ...
 *      Ap: an int32_t/SuiteSparse_long array of size n+1, containing column
 *          pointers of A.
 *      Ai: an int32_t/SuiteSparse_long array of size nz, containing the row
 ...
 *
 *      P: an int32_t/SuiteSparse_long array of size n, containing the output
