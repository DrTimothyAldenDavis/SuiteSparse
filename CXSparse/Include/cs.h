...
/* This is the CXSparse/Include/cs.h file.  It has the same name (cs.h) as
   ...
   more features (support for complex matrices, and both int32_t and
   SuiteSparse_long versions).
 */
...
#define cs_long_t_id    "%" SuiteSparse_long_idd
...
/* -------------------------------------------------------------------------- */
/* double/SuiteSparse_long version of CXSparse */
/* -------------------------------------------------------------------------- */
...
{
    SuiteSparse_long nzmax ; /* maximum number of entries */
    SuiteSparse_long m ;     /* number of rows */
    SuiteSparse_long n ;     /* number of columns */
    SuiteSparse_long *p ;    /* column pointers (size n+1) or col indlces (size nzmax) */
    SuiteSparse_long *i ;    /* row indices, size nzmax */
    double *x ;              /* numerical values, size nzmax */
    SuiteSparse_long nz ;    /* # of entries in triplet matrix, -1 for compressed-col */
} cs_dl ;

cs_dl *cs_dl_add (const cs_dl *A, const cs_dl *B, double alpha, double beta) ;
SuiteSparse_long cs_dl_cholsol (SuiteSparse_long order, const cs_dl *A, double *b) ;
SuiteSparse_long cs_dl_dupl (cs_dl *A) ;
SuiteSparse_long cs_dl_entry (cs_dl *T, SuiteSparse_long i, SuiteSparse_long j, double x) ;
SuiteSparse_long cs_dl_lusol (SuiteSparse_long order, const cs_dl *A, double *b, double tol) ;
SuiteSparse_long cs_dl_gaxpy (const cs_dl *A, const double *x, double *y) ;
cs_dl *cs_dl_multiply (const cs_dl *A, const cs_dl *B) ;
SuiteSparse_long cs_dl_qrsol (SuiteSparse_long order, const cs_dl *A, double *b) ;
cs_dl *cs_dl_transpose (const cs_dl *A, SuiteSparse_long values) ;
cs_dl *cs_dl_compress (const cs_dl *T) ;
double cs_dl_norm (const cs_dl *A) ;
SuiteSparse_long cs_dl_print (const cs_dl *A, SuiteSparse_long brief) ;
cs_dl *cs_dl_load (FILE *f) ;

/* utilities */
void *cs_dl_calloc (SuiteSparse_long n, size_t size) ;
void *cs_dl_free (void *p) ;
void *cs_dl_realloc (void *p, SuiteSparse_long n, size_t size, SuiteSparse_long *ok) ;
cs_dl *cs_dl_spalloc (SuiteSparse_long m, SuiteSparse_long n, SuiteSparse_long nzmax,
    SuiteSparse_long values, SuiteSparse_long t) ;
cs_dl *cs_dl_spfree (cs_dl *A) ;
SuiteSparse_long cs_dl_sprealloc (cs_dl *A, SuiteSparse_long nzmax) ;
void *cs_dl_malloc (SuiteSparse_long n, size_t size) ;

/* --- secondary CSparse routines and data structures ----------------------- */

typedef struct cs_dl_symbolic  /* symbolic Cholesky, LU, or QR analysis */
{
    SuiteSparse_long *pinv ;     /* inverse row perm. for QR, fill red. perm for Chol */
    SuiteSparse_long *q ;        /* fill-reducing column permutation for LU and QR */
    SuiteSparse_long *parent ;   /* elimination tree for Cholesky and QR */
    SuiteSparse_long *cp ;       /* column pointers for Cholesky, row counts for QR */
    SuiteSparse_long *leftmost ; /* leftmost[i] = min(find(A(i,:))), for QR */
    SuiteSparse_long m2 ;        /* # of rows for QR, after adding fictitious rows */
    double lnz ;                 /* # entries in L for LU or Cholesky; in V for QR */
    double unz ;                 /* # entries in U for LU; in R for QR */
} cs_dls ;
...
typedef struct cs_dl_numeric   /* numeric Cholesky, LU, or QR factorization */
{
    ...
    SuiteSparse_long *pinv ;  /* partial pivoting for LU */
    double *B ;               /* beta [0..n-1] for QR */
} cs_dln ;

typedef struct cs_dl_dmperm_results    /* cs_dl_dmperm or cs_dl_scc output */
{
    SuiteSparse_long *p ;     /* size m, row permutation */
    SuiteSparse_long *q ;     /* size n, column permutation */
    SuiteSparse_long *r ;     /* size nb+1, block k is rows r[k] to r[k+1]-1 in A(p,q) */
    SuiteSparse_long *s ;     /* size nb+1, block k is cols s[k] to s[k+1]-1 in A(p,q) */
    SuiteSparse_long nb ;     /* # of blocks in fine dmperm decomposition */
    SuiteSparse_long rr [5] ; /* coarse row decomposition */
    SuiteSparse_long cc [5] ; /* coarse column decomposition */
} cs_dld ;

SuiteSparse_long *cs_dl_amd (SuiteSparse_long order, const cs_dl *A) ;
cs_dln *cs_dl_chol (const cs_dl *A, const cs_dls *S) ;
cs_dld *cs_dl_dmperm (const cs_dl *A, SuiteSparse_long seed) ;
SuiteSparse_long cs_dl_droptol (cs_dl *A, double tol) ;
SuiteSparse_long cs_dl_dropzeros (cs_dl *A) ;
SuiteSparse_long cs_dl_happly (const cs_dl *V, SuiteSparse_long i, double beta, double *x) ;
SuiteSparse_long cs_dl_ipvec (const SuiteSparse_long *p, const double *b, double *x,
    SuiteSparse_long n) ;
SuiteSparse_long cs_dl_lsolve (const cs_dl *L, double *x) ;
SuiteSparse_long cs_dl_ltsolve (const cs_dl *L, double *x) ;
cs_dln *cs_dl_lu (const cs_dl *A, const cs_dls *S, double tol) ;
cs_dl *cs_dl_permute (const cs_dl *A, const SuiteSparse_long *pinv,
    const SuiteSparse_long *q, SuiteSparse_long values) ;
SuiteSparse_long *cs_dl_pinv (const SuiteSparse_long *p, SuiteSparse_long n) ;
SuiteSparse_long cs_dl_pvec (const SuiteSparse_long *p, const double *b,
    double *x, SuiteSparse_long n) ;
cs_dln *cs_dl_qr (const cs_dl *A, const cs_dls *S) ;
cs_dls *cs_dl_schol (SuiteSparse_long order, const cs_dl *A) ;
cs_dls *cs_dl_sqr (SuiteSparse_long order, const cs_dl *A, SuiteSparse_long qr) ;
cs_dl *cs_dl_symperm (const cs_dl *A, const SuiteSparse_long *pinv, SuiteSparse_long values) ;
SuiteSparse_long cs_dl_usolve (const cs_dl *U, double *x) ;
SuiteSparse_long cs_dl_utsolve (const cs_dl *U, double *x) ;
SuiteSparse_long cs_dl_updown (cs_dl *L, SuiteSparse_long sigma, const cs_dl *C,
    const SuiteSparse_long *parent) ;
...
SuiteSparse_long *cs_dl_counts (const cs_dl *A, const SuiteSparse_long *parent,
    const SuiteSparse_long *post, SuiteSparse_long ata) ;
double cs_dl_cumsum (SuiteSparse_long *p, SuiteSparse_long *c, SuiteSparse_long n) ;
SuiteSparse_long cs_dl_dfs (SuiteSparse_long j, cs_dl *G, SuiteSparse_long top,
    SuiteSparse_long *xi, SuiteSparse_long *pstack, const SuiteSparse_long *pinv) ;
SuiteSparse_long *cs_dl_etree (const cs_dl *A, SuiteSparse_long ata) ;
SuiteSparse_long cs_dl_fkeep (cs_dl *A,
    SuiteSparse_long (*fkeep) (SuiteSparse_long, SuiteSparse_long, double, void *), void *other) ;
double cs_dl_house (double *x, double *beta, SuiteSparse_long n) ;
SuiteSparse_long *cs_dl_maxtrans (const cs_dl *A, SuiteSparse_long seed) ;
SuiteSparse_long *cs_dl_post (const SuiteSparse_long *parent, SuiteSparse_long n) ;
cs_dld *cs_dl_scc (cs_dl *A) ;
SuiteSparse_long cs_dl_scatter (const cs_dl *A, SuiteSparse_long j, double beta,
    SuiteSparse_long *w, double *x, SuiteSparse_long mark,cs_dl *C, SuiteSparse_long nz) ;
SuiteSparse_long cs_dl_tdfs (SuiteSparse_long j, SuiteSparse_long k, SuiteSparse_long *head,
    const SuiteSparse_long *next, SuiteSparse_long *post, SuiteSparse_long *stack) ;
SuiteSparse_long cs_dl_leaf (SuiteSparse_long i, SuiteSparse_long j, const SuiteSparse_long *first,
    SuiteSparse_long *maxfirst, SuiteSparse_long *prevleaf, SuiteSparse_long *ancestor,
    SuiteSparse_long *jleaf) ;
SuiteSparse_long cs_dl_reach (cs_dl *G, const cs_dl *B, SuiteSparse_long k, SuiteSparse_long *xi,
    const SuiteSparse_long *pinv) ;
SuiteSparse_long cs_dl_spsolve (cs_dl *L, const cs_dl *B, SuiteSparse_long k, SuiteSparse_long *xi,
    double *x, const SuiteSparse_long *pinv, SuiteSparse_long lo) ;
SuiteSparse_long cs_dl_ereach (const cs_dl *A, SuiteSparse_long k, const SuiteSparse_long *parent,
    SuiteSparse_long *s, SuiteSparse_long *w) ;
SuiteSparse_long *cs_dl_randperm (SuiteSparse_long n, SuiteSparse_long seed) ;

/* utilities */
cs_dld *cs_dl_dalloc (SuiteSparse_long m, SuiteSparse_long n) ;
cs_dl *cs_dl_done (cs_dl *C, void *w, void *x, SuiteSparse_long ok) ;
SuiteSparse_long *cs_dl_idone (SuiteSparse_long *p, cs_dl *C, void *w, SuiteSparse_long ok) ;
cs_dln *cs_dl_ndone (cs_dln *N, cs_dl *C, void *w, void *x, SuiteSparse_long ok) ;
cs_dld *cs_dl_ddone (cs_dld *D, cs_dl *C, void *w, SuiteSparse_long ok) ;
...
/* -------------------------------------------------------------------------- */
/* complex/SuiteSparse_long version of CXSparse */
/* -------------------------------------------------------------------------- */
...
cs_cl *cs_cl_add (const cs_cl *A, const cs_cl *B, cs_complex_t alpha,
    cs_complex_t beta) ;
SuiteSparse_long cs_cl_cholsol (SuiteSparse_long order, const cs_cl *A, cs_complex_t *b) ;
SuiteSparse_long cs_cl_dupl (cs_cl *A) ;
SuiteSparse_long cs_cl_entry (cs_cl *T, SuiteSparse_long i, SuiteSparse_long j, cs_complex_t x) ;
SuiteSparse_long cs_cl_lusol (SuiteSparse_long order, const cs_cl *A, cs_complex_t *b,
    double tol) ;
SuiteSparse_long cs_cl_gaxpy (const cs_cl *A, const cs_complex_t *x, cs_complex_t *y) ;
cs_cl *cs_cl_multiply (const cs_cl *A, const cs_cl *B) ;
SuiteSparse_long cs_cl_qrsol (SuiteSparse_long order, const cs_cl *A, cs_complex_t *b) ;
cs_cl *cs_cl_transpose (const cs_cl *A, SuiteSparse_long values) ;
cs_cl *cs_cl_compress (const cs_cl *T) ;
double cs_cl_norm (const cs_cl *A) ;
SuiteSparse_long cs_cl_print (const cs_cl *A, SuiteSparse_long brief) ;
cs_cl *cs_cl_load (FILE *f) ;

/* utilities */
void *cs_cl_calloc (SuiteSparse_long n, size_t size) ;
void *cs_cl_free (void *p) ;
void *cs_cl_realloc (void *p, SuiteSparse_long n, size_t size, SuiteSparse_long *ok) ;
cs_cl *cs_cl_spalloc (SuiteSparse_long m, SuiteSparse_long n, SuiteSparse_long nzmax,
    SuiteSparse_long values, SuiteSparse_long t) ;
cs_cl *cs_cl_spfree (cs_cl *A) ;
SuiteSparse_long cs_cl_sprealloc (cs_cl *A, SuiteSparse_long nzmax) ;
void *cs_cl_malloc (SuiteSparse_long n, size_t size) ;
...
SuiteSparse_long *cs_cl_amd (SuiteSparse_long order, const cs_cl *A) ;
cs_cln *cs_cl_chol (const cs_cl *A, const cs_cls *S) ;
cs_cld *cs_cl_dmperm (const cs_cl *A, SuiteSparse_long seed) ;
SuiteSparse_long cs_cl_droptol (cs_cl *A, double tol) ;
SuiteSparse_long cs_cl_dropzeros (cs_cl *A) ;
SuiteSparse_long cs_cl_happly (const cs_cl *V, SuiteSparse_long i, double beta,
    cs_complex_t *x) ;
SuiteSparse_long cs_cl_ipvec (const SuiteSparse_long *p, const cs_complex_t *b,
    cs_complex_t *x, SuiteSparse_long n) ;
SuiteSparse_long cs_cl_lsolve (const cs_cl *L, cs_complex_t *x) ;
SuiteSparse_long cs_cl_ltsolve (const cs_cl *L, cs_complex_t *x) ;
cs_cln *cs_cl_lu (const cs_cl *A, const cs_cls *S, double tol) ;
cs_cl *cs_cl_permute (const cs_cl *A, const SuiteSparse_long *pinv, const SuiteSparse_long *q,
    SuiteSparse_long values) ;
SuiteSparse_long *cs_cl_pinv (const SuiteSparse_long *p, SuiteSparse_long n) ;
SuiteSparse_long cs_cl_pvec (const SuiteSparse_long *p, const cs_complex_t *b,
    cs_complex_t *x, SuiteSparse_long n) ;
cs_cln *cs_cl_qr (const cs_cl *A, const cs_cls *S) ;
cs_cls *cs_cl_schol (SuiteSparse_long order, const cs_cl *A) ;
cs_cls *cs_cl_sqr (SuiteSparse_long order, const cs_cl *A, SuiteSparse_long qr) ;
cs_cl *cs_cl_symperm (const cs_cl *A, const SuiteSparse_long *pinv, SuiteSparse_long values) ;
SuiteSparse_long cs_cl_usolve (const cs_cl *U, cs_complex_t *x) ;
SuiteSparse_long cs_cl_utsolve (const cs_cl *U, cs_complex_t *x) ;
SuiteSparse_long cs_cl_updown (cs_cl *L, SuiteSparse_long sigma, const cs_cl *C,
    const SuiteSparse_long *parent) ;
...
SuiteSparse_long *cs_cl_counts (const cs_cl *A, const SuiteSparse_long *parent,
    const SuiteSparse_long *post, SuiteSparse_long ata) ;
double cs_cl_cumsum (SuiteSparse_long *p, SuiteSparse_long *c, SuiteSparse_long n) ;
SuiteSparse_long cs_cl_dfs (SuiteSparse_long j, cs_cl *G, SuiteSparse_long top,
    SuiteSparse_long *xi, SuiteSparse_long *pstack, const SuiteSparse_long *pinv) ;
SuiteSparse_long *cs_cl_etree (const cs_cl *A, SuiteSparse_long ata) ;
SuiteSparse_long cs_cl_fkeep (cs_cl *A,
    SuiteSparse_long (*fkeep) (SuiteSparse_long, SuiteSparse_long, cs_complex_t, void *),
    void *other) ;
cs_complex_t cs_cl_house (cs_complex_t *x, double *beta, SuiteSparse_long n) ;
SuiteSparse_long *cs_cl_maxtrans (const cs_cl *A, SuiteSparse_long seed) ;
SuiteSparse_long *cs_cl_post (const SuiteSparse_long *parent, SuiteSparse_long n) ;
cs_cld *cs_cl_scc (cs_cl *A) ;
SuiteSparse_long cs_cl_scatter (const cs_cl *A, SuiteSparse_long j, cs_complex_t beta,
    SuiteSparse_long *w, cs_complex_t *x, SuiteSparse_long mark,cs_cl *C, SuiteSparse_long nz) ;
SuiteSparse_long cs_cl_tdfs (SuiteSparse_long j, SuiteSparse_long k, SuiteSparse_long *head,
    const SuiteSparse_long *next, SuiteSparse_long *post, SuiteSparse_long *stack) ;
SuiteSparse_long cs_cl_leaf (SuiteSparse_long i, SuiteSparse_long j,
    const SuiteSparse_long *first, SuiteSparse_long *maxfirst,
    SuiteSparse_long *prevleaf, SuiteSparse_long *ancestor, SuiteSparse_long *jleaf) ;
SuiteSparse_long cs_cl_reach (cs_cl *G, const cs_cl *B, SuiteSparse_long k,
    SuiteSparse_long *xi, const SuiteSparse_long *pinv) ;
SuiteSparse_long cs_cl_spsolve (cs_cl *L, const cs_cl *B, SuiteSparse_long k,
    SuiteSparse_long *xi, cs_complex_t *x, const SuiteSparse_long *pinv,
    SuiteSparse_long lo) ;
SuiteSparse_long cs_cl_ereach (const cs_cl *A, SuiteSparse_long k,
    const SuiteSparse_long *parent, SuiteSparse_long *s, SuiteSparse_long *w) ;
SuiteSparse_long *cs_cl_randperm (SuiteSparse_long n, SuiteSparse_long seed) ;

/* utilities */
cs_cld *cs_cl_dalloc (SuiteSparse_long m, SuiteSparse_long n) ;
cs_cl *cs_cl_done (cs_cl *C, void *w, void *x, SuiteSparse_long ok) ;
SuiteSparse_long *cs_cl_idone (SuiteSparse_long *p, cs_cl *C, void *w, SuiteSparse_long ok) ;
cs_cln *cs_cl_ndone (cs_cln *N, cs_cl *C, void *w, void *x, SuiteSparse_long ok) ;
cs_cld *cs_cl_ddone (cs_cld *D, cs_cl *C, void *w, SuiteSparse_long ok) ;
...
#ifdef CS_LONG
#define CS_INT SuiteSparse_long
...
cs_dl *cs_l_real (cs_cl *A, SuiteSparse_long real) ;
cs_cl *cs_l_complex (cs_dl *A, SuiteSparse_long real) ;
#endif
