...
double int Syntax:
    ...
    char *buffer ;
    void *Symbolic ;
    status = umfpack_di_load_symbolic (&Symbolic, buffer) ;
...
double SuiteSparse_long Syntax:
    ...
    char *buffer ;
    void *Symbolic ;
    status = umfpack_dl_load_symbolic (&Symbolic, buffer) ;
...
complex int Syntax:
    ...
    char *buffer ;
    void *Symbolic ;
    status = umfpack_zi_load_symbolic (&Symbolic, buffer) ;
...
complex SuiteSparse_long Syntax:
    ...
    char *buffer ;
    void *Symbolic ;
    status = umfpack_zl_load_symbolic (&Symbolic, buffer) ;
