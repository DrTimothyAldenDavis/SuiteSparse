...
int main (int argc, char **argv)
{
	...
	*Chain_maxrows, *Chain_maxcols, *Front_1strow, *Front_leftmostdesc,
    ...
    printf ("From the Symbolic object, C is of dimension "
            "%" SuiteSparse_long_idd "-by-%" SuiteSparse_long_idd "\n", nr, nc);
    ...
    for (i = 0 ; i < nfr ; i++)
    {
      ...
      printf ("    Front %" SuiteSparse_long_idd ": parent front: %" SuiteSparse_long_idd
