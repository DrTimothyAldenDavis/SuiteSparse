% DIMACS10
%
% Requires ssget, the MATLAB interface to the SuiteSparse Matrix Collection
%
%   dimacs10         - returns a graph from the DIMACS10 test set, via the SuiteSparseCollection.
