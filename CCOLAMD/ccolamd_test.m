...
if (do_compile)
    ...
    cmd = 'mex -O -I../UFconfig ccolamdmex.c ccolamd.c ccolamd_global.c' ;
    fprintf ('%s\n', cmd) ;
    eval (cmd) ;
    cmd = 'mex -O -I../UFconfig csymamdmex.c ccolamd.c ccolamd_global.c' ;
    fprintf ('%s\n', cmd) ;
    eval (cmd) ;
    cmd = 'mex -O -I../UFconfig ccolamdtestmex.c ccolamd.c ccolamd_global.c' ;
    fprintf ('%s\n', cmd) ;
    eval (cmd) ;
    cmd = 'mex -O -I../UFconfig csymamdtestmex.c ccolamd.c ccolamd_global.c' ;
    fprintf ('%s\n', cmd) ;
    eval (cmd) ;
