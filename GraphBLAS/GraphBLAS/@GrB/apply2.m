...
% C = GrB.apply2 (op, A, B, desc)                   % C = op(A,B)
% C = GrB.apply2 (Cin, accum, op, A, B, desc)       % C = Cin ; C += op(A,B)
% C = GrB.apply2 (Cin, M, op, A, B, desc)           % C = Cin ; C<M> = op(A,B)
% C = GrB.apply2 (Cin, M, accum, op, A, B, desc)    % C = Cin ; C<M> += op(A,B)
%
...
% arg7: if present, it must be the descriptor
    ...
    switch (nargin)
        case 3
            [C_opaque, kind] = gbmex_apply2 (0, arg1, arg2, arg3) ;
        case 4
            [C_opaque, kind] = gbmex_apply2 (0, arg1, arg2, arg3, arg4) ;
        case 5
            [C_opaque, kind] = gbmex_apply2 (0, arg1, arg2, arg3, arg4, ...
                arg5) ;
        case 6
