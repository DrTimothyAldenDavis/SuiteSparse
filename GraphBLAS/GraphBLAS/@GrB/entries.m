...
% value.  The GrB.entries function looks only at the pattern of A, not its
% values.  To exclude explicit entries with a value of zero (or any specified
% additive identity value) use GrB.nonz instead.
%
...
%   the same I = GrB.entries (A, 'row', 'list').
%
