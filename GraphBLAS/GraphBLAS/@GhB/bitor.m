...
%BITOR bitwise OR.
% C = bitor (A,B) is the bitwise OR of A and B.  If A and B are matrices, the
...
%
% With a third parameter, C = bitor (A,B,assumedtype) provides a data type to
...
if (nargin == 2)
    C = gb_bitwise (1, 'bitor', A, B) ;
else
    C = gb_bitwise (1, 'bitor', A, B, assumedtype) ;
end
