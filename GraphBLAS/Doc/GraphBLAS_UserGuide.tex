...
See \cite{Davis18} for a journal article on SuiteSparse:GraphBLAS.
...
Scott McMillan, Jos\'e Moreira, and Carl Yang}
\cite{spec,BulucMattsonMcMillanMoreiraYang17}, based on {\em
...
SuiteSparse:GraphBLAS fully conforms to
...
)
{
    ...
    // making v dense is faster if most of the graph is expected to be searched
