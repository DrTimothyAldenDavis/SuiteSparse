//------------------------------------------------------------------------------
// GB_AxB_defs__any_pair_uint16: definitions for a single semiring
//------------------------------------------------------------------------------
...
// A'*B (dot2):        GB (_Adot2B__any_pair_uint16)
// A'*B (dot3):        GB (_Adot3B__any_pair_uint16)
// C+=A'*B (dot4):     GB (_Adot4B__any_pair_uint16)
// A*B (saxpy3):       GB (_Asaxpy3B__any_pair_uint16)
//     no mask:        GB (_Asaxpy3B_noM__any_pair_uint16)
//     mask M:         GB (_Asaxpy3B_M__any_pair_uint16)
//     mask !M:        GB (_Asaxpy3B_notM__any_pair_uint16)
// A*B (saxpy bitmap): GB (_AsaxbitB__any_pair_uint16)
