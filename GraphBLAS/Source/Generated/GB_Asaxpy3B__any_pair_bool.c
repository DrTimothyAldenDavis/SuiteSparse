...
GrB_Info GB (_Asaxpy3B__any_pair_bool)
(
...
{ 
    ...
    {
        // C = A*B, no mask
        return (GB (_Asaxpy3B_noM__any_pair_bool) (C,
    ...
    {
        // C<M> = A*B
        return (GB (_Asaxpy3B_M__any_pair_bool) (C,
    ...
    {
        // C<!M> = A*B
        return (GB (_Asaxpy3B_notM__any_pair_bool) (C,
            M, Mask_struct, M_packed_in_place,
            A, A_is_pattern, B, B_is_pattern,
            SaxpyTasks, ntasks, nfine, nthreads, do_sort, Context)) ;
    }
