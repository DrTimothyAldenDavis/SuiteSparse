...
#error "ParU 0.1.2 requires SuiteSparse_config 7.5.0 or later"
#endif

#if !defined (UMFPACK__VERSION) || \
    (UMFPACK__VERSION < SUITESPARSE__VERCODE(6,3,1))
#error "ParU 0.1.2 requires UMFPACK 6.3.1 or later"
#endif

#if !defined (CHOLMOD__VERSION) || \
    (CHOLMOD__VERSION < SUITESPARSE__VERCODE(5,1,1))
#error "ParU 0.1.2 requires CHOLMOD 5.1.1 or later"
#endif
