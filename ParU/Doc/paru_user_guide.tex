...
FIXME: describe the impact of MKL BLAS on ParU's performance,

FIXME: ParU methods that return the BLAS library used

FIXME: ParU methods that tell if tasking is available for ParU to factorize
using \verb'PARU_1TASK'. 
