...
placed in {\tt KLU/Lib/libklu.a} and {\tt BTF/Lib/libbtf.a}, and in corresponding
{\tt *.so} files (Linux/Unix) or {\tt *.dylib} (Mac), for the shared libraries.
Two KLU demo
